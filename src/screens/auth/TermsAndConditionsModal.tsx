      ...
      edges={['top']}
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text
              style={[
                {color: colors.text, fontSize: 12, fontFamily: fontFamily,marginBottom:5},
              ]}>
        ...
        <ScrollView
          ...
          <View style={styles.contentContainer}>
            ...
            <Section
              title="Location Permissions and Usage"
              contentParts={[
                {
                  type: 'paragraph',
                  text: `Our mobile application may request access to your device’s location services to support essential service-related features. We collect and process location data only with your explicit consent and for the following purposes:`,
                },
                {
                  type: 'numbered',
                  items: [
                    'Technician Tracking: We use real-time location data of our on-field technicians to assign tasks, track service progress, and manage field operations efficiently. This helps ensure timely service delivery and operational transparency.',
                    'Customer Visibility: Customers are allowed to view the current location of the technician assigned to their service request. This feature is intended solely to provide real-time updates on technician arrival and improve customer experience.',
                    'Data Security and Retention: All location data is transmitted over secure channels, stored with strict access controls, and retained only as long as necessary for service fulfillment, operational audits, or legal compliance. Data is deleted or anonymized thereafter.',
